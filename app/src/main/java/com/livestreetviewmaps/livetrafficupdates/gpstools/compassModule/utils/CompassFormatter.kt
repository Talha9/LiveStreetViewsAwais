package com.livestreetviewmaps.livetrafficupdates.gpstools.compassModule.utils

import android.content.Context
import com.livestreetviewmaps.livetrafficupdates.gpstools.R

class CompassFormatter(mContext:Context) {

    private val sides = intArrayOf(0, 45, 90, 135, 180, 225, 270, 315, 360) //9

    private var names: Array<String>? = null

    init {
        initLocalizedNames(mContext)
    }
