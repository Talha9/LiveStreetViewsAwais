package com.livestreetviewmaps.livetrafficupdates.gpstools.earthMapModule
...
class EarthMapMainActivity : AppCompatActivity(), LocationDialogCallback,
    ...
    private fun onClickListeners() {
        ...
        binding!!.header.headerBarSearchTxt.setOnEditorActionListener(object : TextView.OnEditorActionListener {
            override fun onEditorAction(v: TextView?, actionId: Int, event: KeyEvent?): Boolean {
                ...
                if (searchTxt!=null) {
                    ...
                    Toast.makeText(this@EarthMapMainActivity,"Please Enter Place..!",Toast.LENGTH_SHORT).show()
                }
                return true
            }
        })
    ...
    private fun generateLangFromPlaceName(placeName:String){
        ...
        mConvertPlaceNameToLatLng= ConvertPlaceNameToLatLng(this,placeName,object :ConvertPlaceNameToLatLng.GeoTaskCallbackLatlngs{
            override fun onSuccessLocationFetched(fetchedLatLngs: LatLng?) {
                if(fetchedLatLngs!=null){
                    if(fetchedLatLngs.latitude!=null && fetchedLatLngs.longitude!=null){
                        ...
                        Toast.makeText(this@EarthMapMainActivity, "Location not Found..!", Toast.LENGTH_SHORT).show()
                    }
                }else{
                    Toast.makeText(this@EarthMapMainActivity, "Location not Found..!", Toast.LENGTH_SHORT).show()
                }
            ...
            override fun onFailedLocationFetched() {
                Toast.makeText(this@EarthMapMainActivity, "Internet ERROR..!", Toast.LENGTH_SHORT).show()
            }
